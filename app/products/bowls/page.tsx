...
import {
  ...
  bowlLineArt,
} from "../../data/productData"; // Import data

export default function PaperBowlsPage() {
  return (
    <>
      <Navbar />
          ...
          <section id="paper-bowls" className="scroll-mt-20">
            <div className="mb-10">
              <h1 className="text-3xl font-bold tracking-tight text-cyan-800 sm:text-4xl">
                KARTON KASELER / PAPER BOWLS
              </h1>
              <p className="mt-4 text-lg text-slate-700">
                Karton bardakların yanı sıra dondurma, çorba, noodle veya diğer
                ürünler için çevre dostu karton kaseler üretiyoruz.
              </p>
              <p className="mt-3 text-lg text-slate-700">
                As well as paper cups, we are producing eco-friendly paper bowls
                with various sizes for ice cream, soup, noodle or for others.
              </p>
            </div>
            {/* Bowl Specs Table */}
            <div className="mt-8 flow-root">
              <h2 className="mb-6 text-xl font-semibold tracking-tight text-cyan-700 sm:text-2xl">
                Kase Teknik Özellikleri
              </h2>
            ...
            {/* Bowl Line Art Gallery */}
            <div className="mt-12">
              <h2 className="mb-6 text-xl font-semibold tracking-tight text-cyan-700 sm:text-2xl">
                Kase Boyutları Görselleştirme
              </h2>
